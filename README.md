...
# Software Applications to Install If Necessary:
- Visual Studio Code
- MySQL
- Node.js
- Insomnia
...
# Repository Link
The link for the repository where the code is stored is listed below
- <a href="https://github.com/Joker282855/u-develop-it">Link to Repository</a>
